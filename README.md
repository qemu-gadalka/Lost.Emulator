...
## Running
Lost.Emulator will render video with OpenGL or Direct3D, depending on your platform. A slower software-only renderer
...
## Compilation
Lost.Emulator uses C# 7 language features, so requires a compiler that supports them.
